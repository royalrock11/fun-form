    ...
    input.addEventListener("input", (e) => {
      if (e.target.type === "text") {
        ...
        if (inputText.length > 2) {
          colorize("#b62aaf", line, placeholder);
        } else {
...
checkbox.addEventListener("click", () => {
  if (checkbox.checked) {
    ...
    tl2.to(".checkbox-label", { color: "#b62aaf" }, "<");
  } else {
...
button.addEventListener("click", (e) => {
  ...
  tl3.fromTo(".submitted", { opacity: 0, y: 30 }, { opacity: 1 });
